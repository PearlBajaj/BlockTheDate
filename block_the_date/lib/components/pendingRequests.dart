      ...
      child: Column(
        children: <Widget>[
          SizedBox(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return SizedBox(
                    height: 87,
                    width: MediaQuery.of(context).size.width / 1.097,
                    child: Row(
                      children: <Widget>[
                        Container(
                              ...
                              PageRouteBuilder(
                                pageBuilder:
                                    (context, animation1, animation2) =>
                                        RespondScreen(
                                  type: _pendingRequests[index].type,
                                  event: _pendingRequests[index].event,
                                  description:
                                      _pendingRequests[index].description,
                                  date: _pendingRequests[index].date,
                                  location: _pendingRequests[index].location,
                                  email: _pendingRequests[index].email,
                                ),
          ...
          Align(
              ...
              child: Text(
                'View all Requests',
                style: normalTextStyle(12, appLightBlue),
              ))
        ],
      ),
    );
...
class PendingRequestsRSVP extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return SizedBox(
                                    ...
                                    Navigator.push(
                                      ...
                                      PageRouteBuilder(
                                        pageBuilder:
                                          ...
                                          date: _pendingRequests[index].date,
                                          location:
                                              _pendingRequests[index].location,
                                          email: _pendingRequests[index].email,
                                        ),
                                        transitionDuration: Duration(seconds: 0),
                                      ),
